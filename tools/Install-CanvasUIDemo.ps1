...
$root = (Resolve-Path "$PSScriptRoot\..").Path; $evidence = Join-Path $root 'evidence\canvas-ui\R008'
...
$result = [ordered]@{
    installedAtUtc = [DateTime]::UtcNow.ToString('o'); revision = 'R008'; save = 'pre-release/RPG'
