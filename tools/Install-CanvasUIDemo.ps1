...
$root = (Resolve-Path "$PSScriptRoot\..").Path; $evidence = Join-Path $root 'evidence\canvas-ui\R004'
...
$result = [ordered]@{
    installedAtUtc = [DateTime]::UtcNow.ToString('o'); revision = 'R004'; save = 'pre-release/RPG'
