[CmdletBinding()]
param([ValidateSet('a','b','c','d','e','f','g','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v','w','x','y','z')][string]$Cohort = 'a')
...
if($Cohort -ne 'a'){
    ...
    if($Cohort -in @('c','d','e','f','g') -and ($audit.resolvedConfigs -ne 19 -or $audit.equipment.Weapon_Gun_Blunderbuss.basicPower -ne 200 -or
