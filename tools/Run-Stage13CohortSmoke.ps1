...
if($Cohort -ne 'a'){
    ...
    if($Cohort -in @('c','d','e','f','g','h','i','j','k','l','m') -and ($audit.resolvedConfigs -ne 19 -or $audit.equipment.Weapon_Gun_Blunderbuss.basicPower -ne 200 -or
...
if($Cohort -in @('d','e','f','g','h','i','j','k','l','m')){
...
if($Cohort -in @('e','f','g','h','i','j','k','l','m')){
