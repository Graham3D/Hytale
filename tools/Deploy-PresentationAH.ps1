...
if($package.jarHashes.'HyARPG.jar' -ne $expected -or (Get-FileHash $candidate).Hash -ne $expected){throw 'Wrong AH artifact'}
if((Get-FileHash $old).Hash -ne '724276A3F49817E497EFF99483B5C8447A592827FD9198464D8678C91E711D5D'){throw 'Live RPG build changed: review before replacing'}
...
AssertStopped
$staging=Join-Path $mods 'HyARPG.jar.ah-staging'
