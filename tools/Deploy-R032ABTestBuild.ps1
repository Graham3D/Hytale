...
$expected='1CA247EF81C0066C8D4D6CC1C40D0EF0FE2F9E56E0D574E27DFB3D349B430217'
$old='C39517031B70B77241EC0FDF676C6679F74DF09F8EE1945CB8FA784DC97E3588'
...
[ordered]@{deployedAtUtc=[DateTime]::UtcNow.ToString('o');cohort='R032-AB';implemented=$true;packaged=$true;deployed=$true;
