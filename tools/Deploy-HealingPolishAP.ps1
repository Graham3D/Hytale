...
if($package.jarHashes.'HyARPG.jar' -ne $expected -or (Get-FileHash $candidate).Hash -ne $expected){throw 'Wrong AP artifact'}
if((Get-FileHash $old).Hash -ne '0586FB98DA3349584632FAF062C07644371C51C29E51B00EFA9E7E7E14457B36'){throw 'Live RPG build changed: review before replacing'}
...
AssertStopped
$staging=Join-Path $mods 'HyARPG.jar.ap-staging'
