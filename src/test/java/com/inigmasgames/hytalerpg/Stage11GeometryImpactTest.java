...
class Stage11GeometryImpactTest {
    ...
    @Test void targetLockWidthDoesNotBecomeAResolvingPrism(){for(String id:List.of("root_lash","life_drain")){assertFalse(f.accepts(id,"widening"));assertFalse(f.accepts(id,"focused_channel"));}}
