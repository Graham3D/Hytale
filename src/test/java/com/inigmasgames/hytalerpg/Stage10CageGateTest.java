...
class Stage10CageGateTest {
    ...
    @Test void stage10InventoryIncludesApprovedSkeletonArcherFixture(){
        var profiles=Stage04SkillProfiles.loadCanonical(Stage01BTestSupport.bundle().catalog());
        var stage10=Set.of("consume_minion","simulacrum","corpse_burst","wolf_summon","bone_cage","revive_fallen","summon_void_crawlers","brood_call","dominate","summon_skeleton_archers");
