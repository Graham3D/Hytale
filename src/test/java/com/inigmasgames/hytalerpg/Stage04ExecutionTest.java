...
class Stage04ExecutionTest {
    @Test void sixPilotProfilesAreCanonicalAndPounceUsesInnatePower() {
        ...
        assertEquals(Stage04SkillProfiles.EXPECTED_STAGE04_PILOTS
                ...
                profiles.all().values().stream().filter(profile -> profile.area() == null && profile.connection() == null && profile.support() == null && profile.summon() == null && profile.summonAction() == null && profile.conversion() == null).count());
