...
public record FoundationModifiers(boolean longReach, boolean rapidInvocation) {
    public static FoundationModifiers from(List<PassiveId> order) {
        ...
        return new FoundationModifiers(ids.contains("long_reach"),ids.contains("rapid_invocation"));
    }
