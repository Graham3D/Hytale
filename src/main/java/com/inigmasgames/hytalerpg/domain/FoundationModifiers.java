...
public record FoundationModifiers(boolean longReach, boolean rapidInvocation,boolean concentration,boolean lingering,boolean secondWind) {
    public static FoundationModifiers from(List<PassiveId> order) {
        ...
        return new FoundationModifiers(ids.contains("long_reach"),ids.contains("rapid_invocation"),ids.contains("concentration"),ids.contains("lingering"),ids.contains("second_wind"));
    }
