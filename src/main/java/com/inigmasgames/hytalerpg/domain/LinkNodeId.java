...
public enum LinkNodeId {
    SKILL01(NodeKind.SKILL), SKILL02(NodeKind.SKILL), SKILL03(NodeKind.SKILL),
    ...
    public static LinkNodeId parse(String value) {
        ...
        try { return valueOf(normalized); }
            ...
            if (normalized.matches("SKILL[1-3]")) normalized = "SKILL0" + normalized.substring(5);
            ...
            try { return valueOf(normalized); }
                ...
                throw new IllegalArgumentException("Unknown Link node: " + value + " (expected skill01..03, passive01..06, or joint01..02)");
            }
        }
    }
}
