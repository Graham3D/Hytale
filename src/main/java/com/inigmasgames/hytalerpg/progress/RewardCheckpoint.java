...
public record RewardCheckpoint(long currentXp,int level,int pendingPoints,int unspentPoints,
    ...
    public RewardCheckpoint {
        ...
        if(currentXp<0||level<1||level>99||pendingPoints<0||unspentPoints<0||mastery==null||mastery.size()>com.inigmasgames.hytalerpg.content.RpgCatalog.EXPECTED_SKILLS)
