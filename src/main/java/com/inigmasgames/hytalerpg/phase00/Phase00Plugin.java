...
public final class Phase00Plugin extends JavaPlugin {
    ...
    protected void setup() {
        ...
        if(Boolean.getBoolean("rpg.healingPresentationProbe")||com.inigmasgames.hytalerpg.execution.hytale.HealingProbePolicy.liveTestBuild()){
            ...
            LOGGER.atInfo().log("RPG_HEAL_PROBE revision=R032-AL enabled=true permission=inigmasgames.rpg.healingprobe liveTest=%s disposableWorldRequired=%s connectedProof=false",
