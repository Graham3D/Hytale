...
public final class HytaleStatusDeathSystem extends DeathSystems.OnDeathSystem {
    ...
    public static final class Removal extends RefSystem<EntityStore>{
        ...
        @Override public void onEntityRemove(Ref<EntityStore> ref,RemoveReason reason,Store<EntityStore> store,CommandBuffer<EntityStore> buffer){skills.forgetStatusVictim(store.getComponent(ref,UUIDComponent.getComponentType()).getUuid());}
    }
}
