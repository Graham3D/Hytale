...
| 11 | remaining 40 passives; component-scoped matrix/combinations | R030 cohorts A–H local gates complete: sixteen primitives, 861 tests, plan schema17, player schema6 serial charge debt; 24 Stage11 passives remain; connected verification outstanding |
