...
| 11 | remaining 40 passives; component-scoped matrix/combinations | R030 cohorts A–C local gates complete: seven primitives, 741 tests, plan schema12, player schema6 serial charge debt; 33 Stage11 passives remain; connected verification outstanding |
