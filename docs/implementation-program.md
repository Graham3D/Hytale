...
| 11 | remaining 40 passives; component-scoped matrix/combinations | R030 cohorts A–W local primitive gates complete: all forty primitives, 1329 tests, plan schema32, player schema6 serial charge debt; component-matrix/legacy-state closure remains; connected verification outstanding |
