...
| 13 | full 87/66 coverage, hardening, release-candidate assessment | R032 cohorts A–B targeted local gates: latest 1251 tests and normal three-mod smoke; 72 runtime profiles, 15 remaining; paid-dispatch, strike geometry, typed projectile payloads and audited item-power authority corrected; plan schema37; final stage gates not complete; connected UNVERIFIED |
