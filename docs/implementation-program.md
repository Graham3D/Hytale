...
| 11 | remaining 40 passives; component-scoped matrix/combinations | R030 cohorts A–G local gates complete: fifteen primitives, 835 tests, plan schema16, player schema6 serial charge debt; 25 Stage11 passives remain; connected verification outstanding |
