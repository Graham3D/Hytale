...
| 12 | progression, attribution, exact-once rewards and acquisition | R031 cohorts A–D: exact math, schema8 durable awards, audited three-role/four-biome pilots, persistent encounter/farm context and interrupted-party death delivery; 1529 retained tests; native event and acquisition integration in progress; connected verification outstanding |
