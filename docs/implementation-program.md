...
| 13 | full 87/66 coverage, hardening, release-candidate assessment | R032 cohorts A–C targeted local gates: latest 1298 tests and normal three-mod smoke; 78 runtime profiles, 9 remaining; Snipe explicitly activation-gated pending audited native bow range; shared projectile/other-effect root budgets, scheduled missiles, ballistic explosions and native item-power authority corrected; plan schema38; final stage gates not complete; connected UNVERIFIED |
