...
| 12 | progression, attribution, exact-once rewards and acquisition | R031 cohorts A–C: exact math, schema8 durable awards, audited three-role/four-biome pilot registry and bounded contribution/death planning; 1486 retained tests; persistent native encounter and acquisition integration in progress; connected verification outstanding |
