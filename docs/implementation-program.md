...
| 11 | remaining 40 passives; component-scoped matrix/combinations | R030 cohorts A–D local gates complete: nine primitives, 763 tests, plan schema13, player schema6 serial charge debt; 31 Stage11 passives remain; connected verification outstanding |
