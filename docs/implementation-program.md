...
| 12 | progression, attribution, exact-once rewards and acquisition | R031 cohorts A–G: exact math, schema8 durable awards, audited pilots, persistent encounter/farm context, native reward/support/control hooks and meaningful manual-root mastery; trusted party-provider seam defaults unavailable/solo; last full suite 1576, G targeted 530; acquisition/Insight/respec in progress; connected verification outstanding |
