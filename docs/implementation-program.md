...
| 11 | remaining 40 passives; component-scoped matrix/combinations | R030 cohorts A–F local gates complete: fourteen primitives, 809 tests, plan schema15, player schema6 serial charge debt; 26 Stage11 passives remain; connected verification outstanding |
