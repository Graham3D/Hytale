...
| 11 | remaining 40 passives; component-scoped matrix/combinations | R030 cohorts A–E local gates complete: eleven primitives, 786 tests, plan schema14, player schema6 serial charge debt; 29 Stage11 passives remain; connected verification outstanding |
