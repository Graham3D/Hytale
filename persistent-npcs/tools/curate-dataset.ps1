...
if ($LASTEXITCODE -ne 0) { throw 'Build failed before D4 curation.' }
...
& $java -classpath $classpath `
    com.inigmasgames.persistentnpcs.training.cli.Block2Cli curate-fixture `
    $projectRoot $OfflineRoot $ActiveSaveRoot
if ($LASTEXITCODE -ne 0) { throw 'D4 curation gate failed.' }
