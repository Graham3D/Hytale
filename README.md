...
The `RPG` branch is at **Stage 13 / R032-AE**, deployed for connected testing.
...
- Current report and test checklist: [R032-AE presentation correction](docs/stage-13/stage-13-presentation-ae-report.md)
